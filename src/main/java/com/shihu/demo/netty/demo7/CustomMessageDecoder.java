...
public class CustomMessageDecoder extends LengthFieldBasedFrameDecoder {
     ...
     */
    public CustomMessageDecoder(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength, int lengthAdjustment, int initialBytesToStrip, boolean failFast) {
    ...
    protected Object decode(ChannelHandlerContext ctx, ByteBuf in) throws Exception {
        ...
        CustomMessage customMessage = new CustomMessage(type,flag,length,body);
